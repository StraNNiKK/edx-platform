...
define(['jquery', 'backbone', 'underscore', 'gettext', 'js/views/baseview',
    ...
    GatingEditor = AbstractEditor.extend({
        ...
        events : {
            ...
            'click #clear_prereq': 'handleClearPrereq',
