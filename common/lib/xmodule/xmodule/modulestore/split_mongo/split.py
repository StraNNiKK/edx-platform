...
class SplitMongoModuleStore(SplitBulkWriteMixin, ModuleStoreWriteBase):
    ...
    def get_items(self, course_locator, settings=None, content=None, qualifiers=None, in_tree_only=False, **kwargs):
        """
        Returns:
        ...
        kwargs:
            'in_tree_only':
                True - if we want to check if an item is present in the course tree.
                False/ or not set - This would not check if item is present in the course tree or not.
        """
